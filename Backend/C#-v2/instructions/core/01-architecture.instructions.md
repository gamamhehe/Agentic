...
| --- | --- |
| Project and folder layout | `patterns/structure.pattern.md` |
| API endpoints and OpenAPI | `patterns/api.pattern.md` |
| CQRS handlers and validation | `patterns/application.pattern.md` |
| Repositories, caching, DI, HTTP adapters | `patterns/infrastructure.pattern.md` |
| EF Core audit and configuration | `patterns/entity-framework-core.pattern.md` |
| Background jobs | `patterns/hangfire.pattern.md` |
| Domain shared primitives | `patterns/domain.pattern.md` |
| Application Insights and request logging | `patterns/logging.pattern.md` |
| Unit and integration tests | `patterns/testing.pattern.md` |
