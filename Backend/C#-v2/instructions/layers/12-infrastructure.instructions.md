...
See `instructions/core/01-architecture.instructions.md` for the full source project roles and dependency rules.
...
- See infrastructure.pattern.md for fully implemented reference sub-methods.
...
- See `patterns/hangfire.pattern.md` for fully implemented reference code
...
- See `patterns/logging.pattern.md` for reference setup.
