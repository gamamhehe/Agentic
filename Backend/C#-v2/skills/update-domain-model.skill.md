...
Load `instructions/cross-cutting/21-testing.instructions.md` when tests are in scope.

## Related patterns

Use as reference:
- `patterns/domain.pattern.md`
- `patterns/entity-framework-core.pattern.md` only when persistence implications must be understood
