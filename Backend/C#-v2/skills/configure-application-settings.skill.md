...
- `instructions/cross-cutting/21-testing.instructions.md` when configuration tests are in scope

Load `instructions/layers/11-application.instructions.md` or `instructions/layers/12-infrastructure.instructions.md` if the new option belongs to those layers.
