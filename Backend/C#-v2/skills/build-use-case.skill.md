...
Load `instructions/layers/10-domain.instructions.md` when business rules or domain concepts are involved.
Load `instructions/layers/12-infrastructure.instructions.md` when new interfaces or implementations are required.
